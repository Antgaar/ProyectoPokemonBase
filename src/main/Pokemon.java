...
public class Pokemon {
	...
	/*
	 * Pokemon basico Sexo solo podra ser H, M, X Estado solo podra ser paralizado,
	 * quemado, envenenado, toxico, dormido, congelado, pokerus, confuso, enamorado,
	 * drenado, maldito, canto mortal, atrapado, debilitado Si el mote es "" el
	 * pokemon respondera por el nombre de pokedex Los pokemon en este contructor
	 * son considerados "pokemon activos", estos incluyen los pokemon del equipo 1,
	 * 2 y del oponente, en la pokedex se utilizan elementos LinkedList<Pokemon>
	 * temporales
	 * 
	 * 
	 * 
